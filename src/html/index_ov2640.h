// index_ov2640_html.h
#ifndef INDEX_OV2640_HTML_H
#define INDEX_OV2640_HTML_H
...
// Taille exacte du contenu à envoyer (sans le caractère nul final)
const size_t index_ov2640_html_len = sizeof(index_ov2640_html) - 1;
